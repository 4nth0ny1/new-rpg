  ...
  constructor(props){
    ...
    this.state = {
      ...
      cards: [
        ...
        { id: 8, name: 'revive 10 health', image: "https://images.unsplash.com/photo-1563260324-5ebeedc8af7c?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fG1lZCUyMGtpdHxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60", attack: Math.floor(Math.random() * 15), defense: 5  },
      ...
      player_two_hand: [
        { id: 4, name: 'mountain base', image: "https://images.unsplash.com/photo-1570793005386-840846445fed?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bW91bnRhaW4lMjBodXR8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=60", attack: Math.floor(Math.random() * 15), defense: Math.floor(Math.random() * 10)  },
        ...
        <div className="board">
          <div className='player-container'>
            <div className='player-id'>
              ...
              <p>My Turn: {!this.state.turn ? "true" : "false"}</p>
          ...
          <div className='player-container'>
            ...
            <div className='player-id'>
              <h1>Player Two</h1>
              <p>{this.state.playerTwoHealth}</p>
              <p>My Turn: {this.state.turn ? "true" : "false"}</p>
